"use client";
/* OJO: esta página NO usa <Reveal>/<Stagger>, y no hay que reponerlos.
   framer-motion sirve el HTML con `opacity:0` y lo levanta recién cuando el
   IntersectionObserver avisa que entraste en cuadro. Si ese observer no
   dispara —pasa, y se reportó en producción— la página NO SE VE NUNCA. Acá
   pesa doble: es lo que el paciente usa para reservar y para firmar. */
/**
